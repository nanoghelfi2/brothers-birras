...
<?php print_r($aCarrito); ?>

	<p id="whatsapp">
          +54 11 6148-2079 <a href="https://api.whatsapp.com/send?phone=5491161482079&text=<?php echo $sHTML; ?>&source=&data=&app_absent=" class="chat">Ir al chat</a> </p>
